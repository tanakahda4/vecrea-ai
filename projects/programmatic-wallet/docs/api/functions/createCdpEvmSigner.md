...
Defined in: [src/helpers/cdp-evm-signer.ts:42](https://github.com/dentsusoken/vecrea-ai/blob/0eb9a22e94bada7f80d84a403a65048c4f8ff325/projects/programmatic-wallet/src/helpers/cdp-evm-signer.ts#L42)
...
EVM address to sign with (must be authenticated via CDP)

### publicClient

viem PublicClient for readContract (allowance, nonces, etc.)
...
ClientEvmSigner compatible with registerExactEvmScheme
