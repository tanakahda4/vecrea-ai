...
def after_tool_modifier(
    ...
    has_ucp_response = any(key in tool_response for key in ucp_response_keys)
...
root_agent = Agent(
    ...
    instruction=(
        ...
        " invoke the tools available to complete the user's ask. When the user"
        " asks to see, search, show, browse, or buy products (e.g. 'show me"
        " cookies', 'search for milk', 'what do you have?'), always call"
        " search_shopping_catalog first to return product results. Always make"
